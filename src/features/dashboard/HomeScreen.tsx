...
import { MyAssignedTasks } from '../../management/PromoterManagement';
export function HomeScreen() {
  const { tx, money, row } = useUI(); const { state } = useDemo();
  const management = useManagement(); const target = management.state.targets.b1 ?? 75000;
